...
## Feishu / Lark job matching prerequisite
...
under **Capability Center → Plugins → Lark / Feishu**. Resume-to-Base matching
cannot be live-tested until that status is authenticated and the target Base
link is available.
